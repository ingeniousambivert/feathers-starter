...
const { emailTemplate } = require("@utils/mailer/template");
...
module.exports = function (app) {
	...
	function sendEmail(email) {
		return app
			...
			.create(email)
			.then((result) => {
				logger.info("services:authmanagement:notifier", result);
			})
			.catch((error) => {
				logger.error("services:authmanagement:notifier", error);
			});
	}
